...
class K3PurchaseInStorageTask
{
  public:
    struct Cols
    {
        ...
        static const std::string _purchase_in_storage_key;
     ...
     */
    explicit K3PurchaseInStorageTask(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit K3PurchaseInStorageTask(const Json::Value &pJson) noexcept(false);
     ...
     */
    K3PurchaseInStorageTask(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    K3PurchaseInStorageTask() = default;
    ...
    /**  For column purchase_in_storage_key  */
    ///Get the value of the column purchase_in_storage_key, returns the default value if the column is null
    const std::string &getValueOfPurchaseInStorageKey() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPurchaseInStorageKey() const noexcept;

    ///Set the value of the column purchase_in_storage_key
    void setPurchaseInStorageKey(const std::string &pPurchaseInStorageKey) noexcept;
    void setPurchaseInStorageKey(std::string &&pPurchaseInStorageKey) noexcept;
    void setPurchaseInStorageKeyToNull() noexcept;
  ...
  private:
    friend Mapper<K3PurchaseInStorageTask>;
    ...
    std::shared_ptr<std::string> purchaseInStorageKey_;
