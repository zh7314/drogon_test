...
class AdminGroup
{
  public:
    struct Cols
    {
        ...
        static const std::string _parent_group_id;
        static const std::string _group_name;
        static const std::string _permission_ids;
     ...
     */
    explicit AdminGroup(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AdminGroup(const Json::Value &pJson) noexcept(false);
     ...
     */
    AdminGroup(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column parent_group_id  */
    ///Get the value of the column parent_group_id, returns the default value if the column is null
    const uint32_t &getValueOfParentGroupId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint32_t> &getParentGroupId() const noexcept;

    ///Set the value of the column parent_group_id
    void setParentGroupId(const uint32_t &pParentGroupId) noexcept;
    ...
    /**  For column permission_ids  */
    ///Get the value of the column permission_ids, returns the default value if the column is null
    const std::string &getValueOfPermissionIds() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPermissionIds() const noexcept;

    ///Set the value of the column permission_ids
    void setPermissionIds(const std::string &pPermissionIds) noexcept;
    void setPermissionIds(std::string &&pPermissionIds) noexcept;
    void setPermissionIdsToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint32_t> parentGroupId_;
    std::shared_ptr<std::string> groupName_;
    std::shared_ptr<std::string> permissionIds_;
