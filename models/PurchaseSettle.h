...
class PurchaseSettle
{
  public:
    struct Cols
    {
        ...
        static const std::string _purchase_settle_key;
        static const std::string _purchase_order_id;
        static const std::string _settle_date;
        static const std::string _remark;
        static const std::string _settle_status;
        static const std::string _settle_image;
     ...
     */
    explicit PurchaseSettle(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PurchaseSettle(const Json::Value &pJson) noexcept(false);
     ...
     */
    PurchaseSettle(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    PurchaseSettle() = default;
    ...
    /**  For column purchase_settle_key  */
    ///Get the value of the column purchase_settle_key, returns the default value if the column is null
    const std::string &getValueOfPurchaseSettleKey() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPurchaseSettleKey() const noexcept;

    ///Set the value of the column purchase_settle_key
    void setPurchaseSettleKey(const std::string &pPurchaseSettleKey) noexcept;
    void setPurchaseSettleKey(std::string &&pPurchaseSettleKey) noexcept;
    ...
    /**  For column settle_date  */
    ///Get the value of the column settle_date, returns the default value if the column is null
    const ::trantor::Date &getValueOfSettleDate() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getSettleDate() const noexcept;

    ///Set the value of the column settle_date
    void setSettleDate(const ::trantor::Date &pSettleDate) noexcept;
    ...
    /**  For column settle_status  */
    ///Get the value of the column settle_status, returns the default value if the column is null
    const uint8_t &getValueOfSettleStatus() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint8_t> &getSettleStatus() const noexcept;

    ///Set the value of the column settle_status
    void setSettleStatus(const uint8_t &pSettleStatus) noexcept;


    /**  For column settle_image  */
    ///Get the value of the column settle_image, returns the default value if the column is null
    const std::string &getValueOfSettleImage() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getSettleImage() const noexcept;

    ///Set the value of the column settle_image
    void setSettleImage(const std::string &pSettleImage) noexcept;
    void setSettleImage(std::string &&pSettleImage) noexcept;
    void setSettleImageToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> purchaseSettleKey_;
    std::shared_ptr<uint64_t> purchaseOrderId_;
    std::shared_ptr<::trantor::Date> settleDate_;
    std::shared_ptr<std::string> remark_;
    std::shared_ptr<uint8_t> settleStatus_;
    std::shared_ptr<std::string> settleImage_;
