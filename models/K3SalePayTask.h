...
class K3SalePayTask
{
  public:
     ...
     */
    explicit K3SalePayTask(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit K3SalePayTask(const Json::Value &pJson) noexcept(false);
     ...
     */
    K3SalePayTask(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    K3SalePayTask() = default;
