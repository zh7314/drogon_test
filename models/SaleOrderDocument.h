...
class SaleOrderDocument
{
  public:
    struct Cols
    {
        ...
        static const std::string _receive_doc;
     ...
     */
    explicit SaleOrderDocument(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit SaleOrderDocument(const Json::Value &pJson) noexcept(false);
     ...
     */
    SaleOrderDocument(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    SaleOrderDocument() = default;
    ...
    /**  For column receive_doc  */
    ///Get the value of the column receive_doc, returns the default value if the column is null
    const std::string &getValueOfReceiveDoc() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getReceiveDoc() const noexcept;

    ///Set the value of the column receive_doc
    void setReceiveDoc(const std::string &pReceiveDoc) noexcept;
    void setReceiveDoc(std::string &&pReceiveDoc) noexcept;
    void setReceiveDocToNull() noexcept;
  ...
  private:
    friend Mapper<SaleOrderDocument>;
    ...
    std::shared_ptr<std::string> receiveDoc_;
