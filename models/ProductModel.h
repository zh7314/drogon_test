...
class ProductModel
{
  public:
     ...
     */
    explicit ProductModel(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProductModel(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProductModel(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
