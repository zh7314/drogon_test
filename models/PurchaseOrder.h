...
class PurchaseOrder
{
  public:
    struct Cols
    {
        ...
        static const std::string _margin;
        static const std::string _margin_percent;
     ...
     */
    explicit PurchaseOrder(const Row &r, const ssize_t indexOffset = 0) noexcept;
    ...
    void setPayTypeToNull() noexcept;


    /**  For column margin  */
    ///Get the value of the column margin, returns the default value if the column is null
    const std::string &getValueOfMargin() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getMargin() const noexcept;

    ///Set the value of the column margin
    void setMargin(const std::string &pMargin) noexcept;
    void setMargin(std::string &&pMargin) noexcept;
    void setMarginToNull() noexcept;


    /**  For column margin_percent  */
    ///Get the value of the column margin_percent, returns the default value if the column is null
    const uint8_t &getValueOfMarginPercent() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint8_t> &getMarginPercent() const noexcept;

    ///Set the value of the column margin_percent
    void setMarginPercent(const uint8_t &pMarginPercent) noexcept;
    void setMarginPercentToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> margin_;
    std::shared_ptr<uint8_t> marginPercent_;
