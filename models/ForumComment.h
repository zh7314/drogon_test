...
class ForumComment
{
  public:
    struct Cols
    {
        ...
        static const std::string _relate_id;
     ...
     */
    explicit ForumComment(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ForumComment(const Json::Value &pJson) noexcept(false);
     ...
     */
    ForumComment(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ForumComment() = default;
    ...
    /**  For column relate_id  */
    ///Get the value of the column relate_id, returns the default value if the column is null
    const uint64_t &getValueOfRelateId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t> &getRelateId() const noexcept;

    ///Set the value of the column relate_id
    void setRelateId(const uint64_t &pRelateId) noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint64_t> relateId_;
