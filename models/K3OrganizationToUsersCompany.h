/**
 *
 *  K3OrganizationToUsersCompany.h
...
class K3OrganizationToUsersCompany
{
  public:
    struct Cols
    {
     ...
     */
    explicit K3OrganizationToUsersCompany(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit K3OrganizationToUsersCompany(const Json::Value &pJson) noexcept(false);
     ...
     */
    K3OrganizationToUsersCompany(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    K3OrganizationToUsersCompany() = default;
  ...
  private:
    friend Mapper<K3OrganizationToUsersCompany>;
