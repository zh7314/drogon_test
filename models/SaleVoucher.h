...
class SaleVoucher
{
  public:
    struct Cols
    {
        ...
        static const std::string _voucher_type;
     ...
     */
    explicit SaleVoucher(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit SaleVoucher(const Json::Value &pJson) noexcept(false);
     ...
     */
    SaleVoucher(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column voucher_type  */
    ///Get the value of the column voucher_type, returns the default value if the column is null
    const uint8_t &getValueOfVoucherType() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint8_t> &getVoucherType() const noexcept;

    ///Set the value of the column voucher_type
    void setVoucherType(const uint8_t &pVoucherType) noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint8_t> voucherType_;
