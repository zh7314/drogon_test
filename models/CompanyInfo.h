...
class CompanyInfo
{
  public:
    struct Cols
    {
        ...
        static const std::string _company_info;
     ...
     */
    explicit CompanyInfo(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CompanyInfo(const Json::Value &pJson) noexcept(false);
     ...
     */
    CompanyInfo(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column company_info  */
    ///Get the value of the column company_info, returns the default value if the column is null
    const std::string &getValueOfCompanyInfo() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCompanyInfo() const noexcept;

    ///Set the value of the column company_info
    void setCompanyInfo(const std::string &pCompanyInfo) noexcept;
    void setCompanyInfo(std::string &&pCompanyInfo) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> companyInfo_;
