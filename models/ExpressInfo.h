...
class ExpressInfo
{
  public:
    struct Cols
    {
        ...
        static const std::string _delivery_order;
     ...
     */
    explicit ExpressInfo(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ExpressInfo(const Json::Value &pJson) noexcept(false);
     ...
     */
    ExpressInfo(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column delivery_order  */
    ///Get the value of the column delivery_order, returns the default value if the column is null
    const std::string &getValueOfDeliveryOrder() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getDeliveryOrder() const noexcept;

    ///Set the value of the column delivery_order
    void setDeliveryOrder(const std::string &pDeliveryOrder) noexcept;
    void setDeliveryOrder(std::string &&pDeliveryOrder) noexcept;
    void setDeliveryOrderToNull() noexcept;
    ...
    const uint64_t &getValueOfSaleOutStorageSkuId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t> &getSaleOutStorageSkuId() const noexcept;

    ///Set the value of the column sale_out_storage_sku_id
    void setSaleOutStorageSkuId(const uint64_t &pSaleOutStorageSkuId) noexcept;
    void setSaleOutStorageSkuIdToNull() noexcept;
    ...
    void setSaleOutStorageIdToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> deliveryOrder_;
    ...
    std::shared_ptr<uint64_t> saleOutStorageSkuId_;
