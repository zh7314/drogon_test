...
const std::string SaleVoucher::Cols::_id = "id";
const std::string SaleVoucher::Cols::_create_time = "create_time";
const std::string SaleVoucher::Cols::_update_time = "update_time";
const std::string SaleVoucher::Cols::_user_id = "user_id";
const std::string SaleVoucher::Cols::_amount = "amount";
const std::string SaleVoucher::Cols::_pay_voucher = "pay_voucher";
const std::string SaleVoucher::Cols::_status = "status";
const std::string SaleVoucher::Cols::_remark = "remark";
const std::string SaleVoucher::Cols::_company_id = "company_id";
const std::string SaleVoucher::Cols::_admin_id = "admin_id";
const std::string SaleVoucher::Cols::_voucher_key = "voucher_key";
const std::string SaleVoucher::Cols::_operation_source = "operation_source";
const std::string SaleVoucher::Cols::_audit_remark = "audit_remark";
const std::string SaleVoucher::Cols::_is_delete = "is_delete";
const std::string SaleVoucher::Cols::_shop_id = "shop_id";
const std::string SaleVoucher::Cols::_audit_admin_id = "audit_admin_id";
const std::string SaleVoucher::Cols::_voucher_type = "voucher_type";
const std::string SaleVoucher::Cols::_order_key = "order_key";
const std::string SaleVoucher::Cols::_pay_date = "pay_date";
const std::string SaleVoucher::primaryKeyName = "id";
const bool SaleVoucher::hasPrimaryKey = true;
const std::string SaleVoucher::tableName = "sale_voucher";

const std::vector<typename SaleVoucher::MetaData> SaleVoucher::metaData_={
...
{"voucher_type","uint8_t","tinyint(1) unsigned",1,0,0,1},
{"order_key","std::string","varchar(20)",20,0,0,0},
{"pay_date","::trantor::Date","date",0,0,0,1}
};
const std::string &SaleVoucher::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
SaleVoucher::SaleVoucher(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
        ...
        if(!r["voucher_type"].isNull())
        {
            voucherType_=std::make_shared<uint8_t>(r["voucher_type"].as<uint8_t>());
        }
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            voucherType_=std::make_shared<uint8_t>(r[index].as<uint8_t>());
        }
        index = offset + 17;
        if(!r[index].isNull())
        {
...
SaleVoucher::SaleVoucher(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[16].empty() && pJson.isMember(pMasqueradingVector[16]))
    {
        ...
        {
            voucherType_=std::make_shared<uint8_t>((uint8_t)pJson[pMasqueradingVector[16]].asUInt64());
        }
    }
...
SaleVoucher::SaleVoucher(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("voucher_type"))
    {
        dirtyFlag_[16]=true;
        if(!pJson["voucher_type"].isNull())
        {
            voucherType_=std::make_shared<uint8_t>((uint8_t)pJson["voucher_type"].asUInt64());
        }
    }
...
void SaleVoucher::updateByMasqueradedJson(const Json::Value &pJson,
...
void SaleVoucher::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
const uint64_t &SaleVoucher::getValueOfId() const noexcept
{
...
const std::shared_ptr<uint64_t> &SaleVoucher::getId() const noexcept
{
    return id_;
}
void SaleVoucher::setId(const uint64_t &pId) noexcept
{
...
const typename SaleVoucher::PrimaryKeyType & SaleVoucher::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}

const ::trantor::Date &SaleVoucher::getValueOfCreateTime() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &SaleVoucher::getCreateTime() const noexcept
{
    return createTime_;
}
void SaleVoucher::setCreateTime(const ::trantor::Date &pCreateTime) noexcept
{
...
void SaleVoucher::setCreateTimeToNull() noexcept
{
    createTime_.reset();
    dirtyFlag_[1] = true;
}
...
const ::trantor::Date &SaleVoucher::getValueOfUpdateTime() const noexcept
{
    const static ::trantor::Date defaultValue = ::trantor::Date();
    if(updateTime_)
        return *updateTime_;
...
const std::shared_ptr<::trantor::Date> &SaleVoucher::getUpdateTime() const noexcept
{
    return updateTime_;
}
void SaleVoucher::setUpdateTime(const ::trantor::Date &pUpdateTime) noexcept
{
...
void SaleVoucher::setUpdateTimeToNull() noexcept
{
    updateTime_.reset();
    dirtyFlag_[2] = true;
}
...
const uint64_t &SaleVoucher::getValueOfUserId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(userId_)
        return *userId_;
...
const std::shared_ptr<uint64_t> &SaleVoucher::getUserId() const noexcept
{
    return userId_;
}
void SaleVoucher::setUserId(const uint64_t &pUserId) noexcept
{
...
const std::string &SaleVoucher::getValueOfAmount() const noexcept
{
...
const std::shared_ptr<std::string> &SaleVoucher::getAmount() const noexcept
{
    return amount_;
}
void SaleVoucher::setAmount(const std::string &pAmount) noexcept
{
    amount_ = std::make_shared<std::string>(pAmount);
    dirtyFlag_[4] = true;
}
void SaleVoucher::setAmount(std::string &&pAmount) noexcept
{
...
const std::string &SaleVoucher::getValueOfPayVoucher() const noexcept
{
    const static std::string defaultValue = std::string();
    if(payVoucher_)
        return *payVoucher_;
...
const std::shared_ptr<std::string> &SaleVoucher::getPayVoucher() const noexcept
{
    return payVoucher_;
}
void SaleVoucher::setPayVoucher(const std::string &pPayVoucher) noexcept
{
    payVoucher_ = std::make_shared<std::string>(pPayVoucher);
    dirtyFlag_[5] = true;
}
void SaleVoucher::setPayVoucher(std::string &&pPayVoucher) noexcept
{
...
void SaleVoucher::setPayVoucherToNull() noexcept
{
    payVoucher_.reset();
    dirtyFlag_[5] = true;
}
...
const uint8_t &SaleVoucher::getValueOfStatus() const noexcept
{
...
const std::shared_ptr<uint8_t> &SaleVoucher::getStatus() const noexcept
{
    return status_;
}
void SaleVoucher::setStatus(const uint8_t &pStatus) noexcept
{
...
const std::string &SaleVoucher::getValueOfRemark() const noexcept
{
    const static std::string defaultValue = std::string();
    if(remark_)
        return *remark_;
...
const std::shared_ptr<std::string> &SaleVoucher::getRemark() const noexcept
{
    return remark_;
}
void SaleVoucher::setRemark(const std::string &pRemark) noexcept
{
    remark_ = std::make_shared<std::string>(pRemark);
    dirtyFlag_[7] = true;
}
void SaleVoucher::setRemark(std::string &&pRemark) noexcept
{
...
void SaleVoucher::setRemarkToNull() noexcept
{
    remark_.reset();
    dirtyFlag_[7] = true;
}
...
const uint64_t &SaleVoucher::getValueOfCompanyId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(companyId_)
        return *companyId_;
...
const std::shared_ptr<uint64_t> &SaleVoucher::getCompanyId() const noexcept
{
    return companyId_;
}
void SaleVoucher::setCompanyId(const uint64_t &pCompanyId) noexcept
{
...
const uint64_t &SaleVoucher::getValueOfAdminId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(adminId_)
        return *adminId_;
...
const std::shared_ptr<uint64_t> &SaleVoucher::getAdminId() const noexcept
{
    return adminId_;
}
void SaleVoucher::setAdminId(const uint64_t &pAdminId) noexcept
{
...
const std::string &SaleVoucher::getValueOfVoucherKey() const noexcept
{
    const static std::string defaultValue = std::string();
    if(voucherKey_)
        return *voucherKey_;
...
const std::shared_ptr<std::string> &SaleVoucher::getVoucherKey() const noexcept
{
    return voucherKey_;
}
void SaleVoucher::setVoucherKey(const std::string &pVoucherKey) noexcept
{
    voucherKey_ = std::make_shared<std::string>(pVoucherKey);
    dirtyFlag_[10] = true;
}
void SaleVoucher::setVoucherKey(std::string &&pVoucherKey) noexcept
{
...
const uint8_t &SaleVoucher::getValueOfOperationSource() const noexcept
{
    const static uint8_t defaultValue = uint8_t();
    if(operationSource_)
...
const std::shared_ptr<uint8_t> &SaleVoucher::getOperationSource() const noexcept
{
    return operationSource_;
}
void SaleVoucher::setOperationSource(const uint8_t &pOperationSource) noexcept
{
...
const std::string &SaleVoucher::getValueOfAuditRemark() const noexcept
{
    const static std::string defaultValue = std::string();
    if(auditRemark_)
        return *auditRemark_;
...
const std::shared_ptr<std::string> &SaleVoucher::getAuditRemark() const noexcept
{
    return auditRemark_;
}
void SaleVoucher::setAuditRemark(const std::string &pAuditRemark) noexcept
{
    auditRemark_ = std::make_shared<std::string>(pAuditRemark);
    dirtyFlag_[12] = true;
}
void SaleVoucher::setAuditRemark(std::string &&pAuditRemark) noexcept
{
...
void SaleVoucher::setAuditRemarkToNull() noexcept
{
    auditRemark_.reset();
    dirtyFlag_[12] = true;
}
...
const uint8_t &SaleVoucher::getValueOfIsDelete() const noexcept
{
    const static uint8_t defaultValue = uint8_t();
    if(isDelete_)
        return *isDelete_;
...
const std::shared_ptr<uint8_t> &SaleVoucher::getIsDelete() const noexcept
{
    return isDelete_;
}
void SaleVoucher::setIsDelete(const uint8_t &pIsDelete) noexcept
{
...
const uint64_t &SaleVoucher::getValueOfShopId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(shopId_)
        return *shopId_;
...
const std::shared_ptr<uint64_t> &SaleVoucher::getShopId() const noexcept
{
    return shopId_;
}
void SaleVoucher::setShopId(const uint64_t &pShopId) noexcept
{
...
const uint64_t &SaleVoucher::getValueOfAuditAdminId() const noexcept
{
    const static uint64_t defaultValue = uint64_t();
    if(auditAdminId_)
...
const std::shared_ptr<uint64_t> &SaleVoucher::getAuditAdminId() const noexcept
{
    return auditAdminId_;
}
void SaleVoucher::setAuditAdminId(const uint64_t &pAuditAdminId) noexcept
{
...
const uint8_t &SaleVoucher::getValueOfVoucherType() const noexcept
{
    const static uint8_t defaultValue = uint8_t();
    if(voucherType_)
        return *voucherType_;
...
const std::shared_ptr<uint8_t> &SaleVoucher::getVoucherType() const noexcept
{
    return voucherType_;
}
void SaleVoucher::setVoucherType(const uint8_t &pVoucherType) noexcept
{
    voucherType_ = std::make_shared<uint8_t>(pVoucherType);
    dirtyFlag_[16] = true;
}
...
const std::string &SaleVoucher::getValueOfOrderKey() const noexcept
{
    const static std::string defaultValue = std::string();
    if(orderKey_)
        return *orderKey_;
...
const std::shared_ptr<std::string> &SaleVoucher::getOrderKey() const noexcept
{
    return orderKey_;
}
void SaleVoucher::setOrderKey(const std::string &pOrderKey) noexcept
{
    orderKey_ = std::make_shared<std::string>(pOrderKey);
    dirtyFlag_[17] = true;
}
void SaleVoucher::setOrderKey(std::string &&pOrderKey) noexcept
{
...
void SaleVoucher::setOrderKeyToNull() noexcept
{
    orderKey_.reset();
    dirtyFlag_[17] = true;
}
...
const ::trantor::Date &SaleVoucher::getValueOfPayDate() const noexcept
{
    const static ::trantor::Date defaultValue = ::trantor::Date();
    if(payDate_)
        return *payDate_;
...
const std::shared_ptr<::trantor::Date> &SaleVoucher::getPayDate() const noexcept
{
    return payDate_;
}
void SaleVoucher::setPayDate(const ::trantor::Date &pPayDate) noexcept
{
...
void SaleVoucher::updateId(const uint64_t id)
{
    id_ = std::make_shared<uint64_t>(id);
}

const std::vector<std::string> &SaleVoucher::insertColumns() noexcept
{
...
void SaleVoucher::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getCreateTime())
...
const std::vector<std::string> SaleVoucher::updateColumns() const
{
...
void SaleVoucher::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[1])
    {
        if(getCreateTime())
...
Json::Value SaleVoucher::toJson() const
{
    Json::Value ret;
    if(getId())
    {
    ...
    if(getVoucherType())
    {
        ret["voucher_type"]=getValueOfVoucherType();
    }
    else
    {
        ret["voucher_type"]=Json::Value();
    }
    if(getOrderKey())
    {
...
Json::Value SaleVoucher::toMasqueradedJson(
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 19)
    {
        ...
        if(!pMasqueradingVector[16].empty())
        {
            if(getVoucherType())
            {
                ret[pMasqueradingVector[16]]=getValueOfVoucherType();
            }
            else
            {
        ...
        if(!pMasqueradingVector[18].empty())
        {
            if(getPayDate())
            {
                ret[pMasqueradingVector[18]]=getPayDate()->toDbStringLocal();
            }
            else
            {
...
bool SaleVoucher::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("voucher_type"))
    {
        if(!validJsonOfField(16, "voucher_type", pJson["voucher_type"], err, true))
            return false;
    }
    if(pJson.isMember("order_key"))
    {
    ...
    if(pJson.isMember("pay_date"))
    {
        if(!validJsonOfField(18, "pay_date", pJson["pay_date"], err, true))
            return false;
    }
    return true;
}
bool SaleVoucher::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool SaleVoucher::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("voucher_type"))
    {
        if(!validJsonOfField(16, "voucher_type", pJson["voucher_type"], err, false))
            return false;
    }
    if(pJson.isMember("order_key"))
    {
    ...
    if(pJson.isMember("pay_date"))
    {
        if(!validJsonOfField(18, "pay_date", pJson["pay_date"], err, false))
            return false;
    }
    return true;
}
bool SaleVoucher::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                   const std::vector<std::string> &pMasqueradingVector,
                                                   std::string &err)
{
    if(pMasqueradingVector.size() != 19)
...
bool SaleVoucher::validJsonOfField(size_t index,
