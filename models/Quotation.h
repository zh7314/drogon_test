...
class Quotation
{
  public:
     ...
     */
    explicit Quotation(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Quotation(const Json::Value &pJson) noexcept(false);
     ...
     */
    Quotation(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const ::trantor::Date &getValueOfReleaseDate() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getReleaseDate() const noexcept;

    ///Set the value of the column release_date
    void setReleaseDate(const ::trantor::Date &pReleaseDate) noexcept;
  ...
  private:
    ...
    std::shared_ptr<::trantor::Date> releaseDate_;
