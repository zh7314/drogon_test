...
class Banner
{
  public:
    struct Cols
    {
        ...
        static const std::string _banner_cate_id;
    };
     ...
     */
    explicit Banner(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Banner(const Json::Value &pJson) noexcept(false);
     ...
     */
    Banner(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column banner_cate_id  */
    ///Get the value of the column banner_cate_id, returns the default value if the column is null
    const uint64_t &getValueOfBannerCateId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t> &getBannerCateId() const noexcept;

    ///Set the value of the column banner_cate_id
    void setBannerCateId(const uint64_t &pBannerCateId) noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint64_t> bannerCateId_;
    struct MetaData
    {
