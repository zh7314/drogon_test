...
class ShopCart
{
  public:
     ...
     */
    explicit ShopCart(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ShopCart(const Json::Value &pJson) noexcept(false);
     ...
     */
    ShopCart(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column buy_number  */
    ///Get the value of the column buy_number, returns the default value if the column is null
    const std::string &getValueOfBuyNumber() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getBuyNumber() const noexcept;

    ///Set the value of the column buy_number
    void setBuyNumber(const std::string &pBuyNumber) noexcept;
    void setBuyNumber(std::string &&pBuyNumber) noexcept;
    ...
    /**  For column cart_type  */
    ///Get the value of the column cart_type, returns the default value if the column is null
    const uint8_t &getValueOfCartType() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint8_t> &getCartType() const noexcept;

    ///Set the value of the column cart_type
    void setCartType(const uint8_t &pCartType) noexcept;


    /**  For column cart_from  */
    ///Get the value of the column cart_from, returns the default value if the column is null
    const std::string &getValueOfCartFrom() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getCartFrom() const noexcept;

    ///Set the value of the column cart_from
    void setCartFrom(const std::string &pCartFrom) noexcept;
    void setCartFrom(std::string &&pCartFrom) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> buyNumber_;
    std::shared_ptr<uint64_t> shopId_;
    std::shared_ptr<int64_t> companyId_;
    std::shared_ptr<uint64_t> quotePriceId_;
    std::shared_ptr<uint8_t> cartType_;
    std::shared_ptr<std::string> cartFrom_;
    struct MetaData
    {
