...
class PurchasePointPriceSku
{
  public:
    struct Cols
    {
        ...
        static const std::string _purchase_point_price_id;
        static const std::string _purchase_order_sku_id;
        static const std::string _point_month;
        static const std::string _point_number;
     ...
     */
    explicit PurchasePointPriceSku(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PurchasePointPriceSku(const Json::Value &pJson) noexcept(false);
     ...
     */
    PurchasePointPriceSku(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    PurchasePointPriceSku() = default;
    ...
    /**  For column purchase_point_price_id  */
    ///Get the value of the column purchase_point_price_id, returns the default value if the column is null
    const uint64_t &getValueOfPurchasePointPriceId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t> &getPurchasePointPriceId() const noexcept;

    ///Set the value of the column purchase_point_price_id
    void setPurchasePointPriceId(const uint64_t &pPurchasePointPriceId) noexcept;
    ...
    /**  For column point_number  */
    ///Get the value of the column point_number, returns the default value if the column is null
    const std::string &getValueOfPointNumber() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPointNumber() const noexcept;

    ///Set the value of the column point_number
    void setPointNumber(const std::string &pPointNumber) noexcept;
    void setPointNumber(std::string &&pPointNumber) noexcept;
  ...
  private:
    friend Mapper<PurchasePointPriceSku>;
    ...
    std::shared_ptr<uint64_t> purchasePointPriceId_;
    std::shared_ptr<uint64_t> purchaseOrderSkuId_;
    std::shared_ptr<std::string> pointMonth_;
    std::shared_ptr<std::string> pointNumber_;
