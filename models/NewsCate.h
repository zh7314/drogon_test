...
class NewsCate
{
  public:
    struct Cols
    {
        ...
        static const std::string _index_show;
     ...
     */
    explicit NewsCate(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit NewsCate(const Json::Value &pJson) noexcept(false);
     ...
     */
    NewsCate(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column index_show  */
    ///Get the value of the column index_show, returns the default value if the column is null
    const std::string &getValueOfIndexShow() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getIndexShow() const noexcept;

    ///Set the value of the column index_show
    void setIndexShow(const std::string &pIndexShow) noexcept;
    void setIndexShow(std::string &&pIndexShow) noexcept;
    void setIndexShowToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> indexShow_;
