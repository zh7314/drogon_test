...
class ForumFavour
{
  public:
     ...
     */
    explicit ForumFavour(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ForumFavour(const Json::Value &pJson) noexcept(false);
     ...
     */
    ForumFavour(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
